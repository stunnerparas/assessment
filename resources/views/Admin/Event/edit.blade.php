...
<body>
           ...
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="updateEvent/{{$row['id']}}" method="POST" onsubmit="return validation()"  enctype="multipart/form-data" >
                  {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="event_title" value="{{$row['title']}}" placeholder="Name of Event" >
                      <div style="color:red;font-style: italic;" id="event_titleerror"></div>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputName1">Event Address</label>
                      <input type="text" name="address" class="form-control" id="event_address" value="{{$row['address']}}" placeholder="Address" >
  ...
  <!-- container-scroller -->
        ...
        <!-- Validation of input field of Form  -->
